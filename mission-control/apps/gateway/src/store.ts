    ...
    const agents: AgentDefinition[] = [
      {
        ...
        tools: [
          ...
          { connectorId: "conn_utility", toolName: "send_notification", requireApproval: true },
        ],
        status: "idle",
        costToDate: 0,
        createdAt: ts,
      ...
      },
      {
        ...
        tools: [{ connectorId: "conn_utility", toolName: "get_time", requireApproval: false }],
        status: "idle",
        costToDate: 0,
        createdAt: ts,
        updatedAt: ts,
      },
      {
        ...
        tools: [{ connectorId: "conn_tradingview", toolName: "chart_get_state", requireApproval: false }],
        status: "idle",
        costToDate: 0,
        createdAt: ts,
        updatedAt: ts,
